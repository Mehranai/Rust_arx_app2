...
async fn process_tx(
    ...
    save_wallet_bsc(provider.clone(), clickhouse.clone(), limiter.clone(), from).await?;
...
pub async fn fetch_bsc(loader: Arc<LoaderBsc>, start_block: u64, total_txs: u64) -> Result<()> {
